...
class ContainsPypiModulesConflict(Enum):
...
class CidrBlock(BaseModel):
    cidrBlock: Optional[str] = Field(
        None, description='CIDR block that must be specified in CIDR notation.'
    )
    displayName: Optional[str] = Field(
        None, description='User-defined name that identifies the CIDR block.'
    )


class CloudDataLineageIntegration(BaseModel):
...
class ExecuteAirflowCommandResponse(BaseModel):
    error: Optional[str] = Field(
        None, description='Error message. Empty if there was no error.'
    )
    executionId: Optional[str] = Field(
        None, description='The unique ID of the command execution for polling.'
    )
    pod: Optional[str] = Field(
        None, description='The name of the pod where the command is executed.'
    )
    podNamespace: Optional[str] = Field(
        None, description='The namespace of the pod where the command is executed.'
    )
...
class ExitInfo(BaseModel):
    ...
    exitCode: Optional[int] = Field(
        None, description='The exit code from the command execution.'
    )
...
class ImageVersion(BaseModel):
    ...
    releaseDate: Optional[Date] = Field(
        None, description='The date of the version release.'
    )
    supportedPythonVersions: Optional[List[str]] = Field(
        None, description='supported python versions'
    )
    upgradeDisabled: Optional[bool] = Field(
        None,
...
class Line(BaseModel):
    content: Optional[str] = Field(None, description='Text content of the log line.')
    lineNumber: Optional[int] = Field(None, description='Number of the line.')


class ListImageVersionsResponse(BaseModel):
    imageVersions: Optional[List[ImageVersion]] = Field(
        None, description='The list of supported ImageVersions in a location.'
    )
...
class NodeConfig(BaseModel):
    ...
    enableIpMasqAgent: Optional[bool] = Field(
        None,
    ...
    ipAllocationPolicy: Optional[IPAllocationPolicy] = Field(
        None, description='Optional. The IPAllocationPolicy fields for the GKE cluster.'
    )
...
class OperationMetadata(BaseModel):
    ...
    operationType: Optional[OperationType] = Field(
        None, description='Output only. The type of operation being performed.'
    )
    ...
    resourceUuid: Optional[str] = Field(
        None, description='Output only. The UUID of the resource being operated on.'
    )
    state: Optional[State1] = Field(
        None, description='Output only. The current operation state.'
    )


class PollAirflowCommandResponse(BaseModel):
    exitInfo: Optional[ExitInfo] = Field(
        None, description='The result exit status of the command.'
    )
    output: Optional[List[Line]] = Field(
        None,
...
class PrivateClusterConfig(BaseModel):
    ...
    masterIpv4ReservedRange: Optional[str] = Field(
        None,
...
class PrivateEnvironmentConfig(BaseModel):
    cloudComposerConnectionSubnetwork: Optional[str] = Field(
        None,
    ...
    cloudComposerNetworkIpv4CidrBlock: Optional[str] = Field(
        None,
        description='Optional. The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.',
    )
    cloudComposerNetworkIpv4ReservedRange: Optional[str] = Field(
        None,
    ...
    cloudSqlIpv4CidrBlock: Optional[str] = Field(
        None,
    ...
    enablePrivateEnvironment: Optional[bool] = Field(
        None,
    ...
    enablePrivatelyUsedPublicIps: Optional[bool] = Field(
        None,
    ...
    networkingConfig: Optional[NetworkingConfig] = Field(
        None,
    ...
    webServerIpv4CidrBlock: Optional[str] = Field(
        None,
    ...
    webServerIpv4ReservedRange: Optional[str] = Field(
        None,
...
class RestartWebServerRequest(BaseModel):
    pass


class SaveSnapshotRequest(BaseModel):
    snapshotLocation: Optional[str] = Field(
        None,
...
class ScheduledSnapshotsConfig(BaseModel):
    enabled: Optional[bool] = Field(
        None, description='Optional. Whether scheduled snapshots creation is enabled.'
    )
    snapshotCreationSchedule: Optional[str] = Field(
        None,
...
class SoftwareConfig(BaseModel):
    airflowConfigOverrides: Optional[Dict[str, str]] = Field(
        None,
    ...
    cloudDataLineageIntegration: Optional[CloudDataLineageIntegration] = Field(
        None,
    ...
    pypiPackages: Optional[Dict[str, str]] = Field(
        None,
        description='Optional. Custom Python Package Index (PyPI) packages to be installed in the environment. Keys refer to the lowercase package name such as "numpy" and values are the lowercase extras and version specifier such as "==1.12.0", "[devel,gcp_api]", or "[devel]>=1.8.2, <1.9.2". To specify a package without pinning it to a version specifier, use the empty string as the value.',
    )
    pythonVersion: Optional[str] = Field(
        None,
    ...
    schedulerCount: Optional[int] = Field(
        None,
...
class TriggererResource(BaseModel):
    count: Optional[int] = Field(
        None, description='Optional. The number of triggerers.'
    )
    cpu: Optional[float] = Field(
        None,
...
class WebServerNetworkAccessControl(BaseModel):
    allowedIpRanges: Optional[List[AllowedIpRange]] = Field(
        None, description='A collection of allowed IP ranges with descriptions.'
    )


class WebServerResource(BaseModel):
    cpu: Optional[float] = Field(
        None, description='Optional. CPU request and limit for Airflow web server.'
    )
    memoryGb: Optional[float] = Field(
        None,
...
class WorkerResource(BaseModel):
    ...
    maxCount: Optional[int] = Field(
        None, description='Optional. Maximum number of workers for autoscaling.'
    )
    memoryGb: Optional[float] = Field(
        None,
    ...
    minCount: Optional[int] = Field(
        None, description='Optional. Minimum number of workers for autoscaling.'
    )
    storageGb: Optional[float] = Field(
        None,
...
class WorkloadsConfig(BaseModel):
    scheduler: Optional[SchedulerResource] = Field(
        None, description='Optional. Resources used by Airflow schedulers.'
    )
    triggerer: Optional[TriggererResource] = Field(
        None, description='Optional. Resources used by Airflow triggerers.'
    )
    webServer: Optional[WebServerResource] = Field(
        None, description='Optional. Resources used by Airflow web server.'
    )
    worker: Optional[WorkerResource] = Field(
        None, description='Optional. Resources used by Airflow workers.'
    )
...
class RecoveryConfig(BaseModel):
    scheduledSnapshotsConfig: Optional[ScheduledSnapshotsConfig] = Field(
        None,
...
class EnvironmentConfig(BaseModel):
    airflowByoidUri: Optional[str] = Field(
        None,
    ...
    dagGcsPrefix: Optional[str] = Field(
        None,
    ...
    databaseConfig: Optional[DatabaseConfig] = Field(
        None,
    ...
    environmentSize: Optional[EnvironmentSize] = Field(
        None,
    ...
    nodeConfig: Optional[NodeConfig] = Field(
        None, description='The configuration used for the Kubernetes Engine cluster.'
    )
    ...
    privateEnvironmentConfig: Optional[PrivateEnvironmentConfig] = Field(
        None,
        description='The configuration used for the Private IP Cloud Composer environment.',
    )
    recoveryConfig: Optional[RecoveryConfig] = Field(
        None,
    ...
    webServerConfig: Optional[WebServerConfig] = Field(
        None,
    ...
    webServerNetworkAccessControl: Optional[WebServerNetworkAccessControl] = Field(
        None,
    ...
    workloadsConfig: Optional[WorkloadsConfig] = Field(
        None,
...
class Environment(BaseModel):
    config: Optional[EnvironmentConfig] = Field(
        None, description='Configuration parameters for this environment.'
    )
    createTime: Optional[str] = Field(
        None, description='Output only. The time at which this environment was created.'
    )
